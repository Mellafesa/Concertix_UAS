...
class kategoriController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($tiket){
            ...
            return response()->json([
                'success' => 201,
                'message' => "Data kategori tiket berhasil disimpan",
                'data' => $table
             ],
             201);
        } else {
            ...
            return response()->json([
                'success' => 401,
                'message' => "Data kategori tiket tidak ditemukan", 
            ]);  
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($tiket){
            ...
            if($kategori){
                ...
                return response()->json([
                    'status' => 200,
                    'message' => "Data kategori tiket berhasil diubah", 
                    'data' => $kategori
                ], 200);
    ...
    public function destroy($id)
    {
        ...
        if($kategori){
            ...
            return response()->json([
                'status' => 200,
                'message' => "Data kategori tiket berhasil dihapus", 
            ], 200);
        } else {
            return response()->json([
                'status' => 404,
